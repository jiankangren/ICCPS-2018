...
\author{Mahmoud Elnaggar and Nicola Bezzo <-this % stops a space
...
\section{Attacker Intention Inference}\label{sec:approach}
\subsection{Bayesian Inverse Reinforcement Learning Intention Prediction}\label{sec:approach1}
...
\begin{equation} Pr(g_j|\mathcal{O}_{i,t_d:t}) \propto Pr(\mathcal{O}_{i,t_d:t} | g_j) \\ \times Pr(g_j|\mathcal{O}_{i,t_d:t-1})
...
\caption{The discretized environment used during experiments with the reward and transition probability models.} 
