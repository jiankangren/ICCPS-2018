...
Our current and future work are toward expanding this framework to deal with continuous states and action spaces, and the problem of {\em checkpointing} and {\em recovery}, to retrieve the point in past time where an attack started.
